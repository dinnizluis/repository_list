                ...
                <div >
                    <label className={classes.container}>
                        <div className={classes.leftSide}>
                            ...
                            <div className={classes.infoItem}>anakinskywalker</div>
                            <div className={classes.infoItem}>
                                <Organization className={classes.infoIcon}/>
                                <Img src={('../../assets/icons/organization.svg')} className={classes.infoIcon} />
                                ...
                                <ListItem>
                                    <div>
                                        <div>
                                            <ListItemText
                                                primary="Death Start"
                                                secondary="The most powerful weapon in the universe"
                                            />
                                        </div>
